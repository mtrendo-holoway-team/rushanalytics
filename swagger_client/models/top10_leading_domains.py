...
class Top10LeadingDomains(dict):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """Top10LeadingDomains - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Top10LeadingDomains, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Top10LeadingDomains):
            return False
